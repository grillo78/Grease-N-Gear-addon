...
public class RenderAE86 extends AbstractRenderVehicle<AE86Entity> {
    ...
    public void render(AE86Entity entity, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float partialTicks, int light) {
        ...
        matrixStack.translate(-0.25D, -0.1D, 0.3D);
        ...
        float turnRotation = wheelAngleNormal * 160.0F;
        ...
        matrixStack.mulPose(new Quaternion(-30 * entity.getPopUpProgress(), 0, 0, true));
    ...
    @Override
    public void applyPlayerModel(AE86Entity entity, PlayerEntity player, PlayerModel<AbstractClientPlayerEntity> model, float partialTicks) {
        super.applyPlayerModel(entity, player, model, partialTicks);
